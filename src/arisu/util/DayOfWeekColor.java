...
public enum DayOfWeekColor {
	MONDAY(Color.web("#f1c40f")), TUESDAY(Color.web("#f368e0")), WEDNESDAY(Color.web("#2ecc71")),
	THURSDAY(Color.web("#e67e22")), FRIDAY(Color.web("#3498db")), SATURDAY(Color.web("#9b59b6")),
